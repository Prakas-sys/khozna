...
void main() async {
  ...
  if (result.exitCode == 0) {
    ...
    var installResult = await Process.run('C:\\Users\\praka\\AppData\\Local\\Android\\Sdk\\platform-tools\\adb.exe', ['install', '-r', 'build\\app\\outputs\\flutter-apk\\app-debug.apk']);
    ...
    if (installResult.exitCode == 0) {
      ...
      var launchResult = await Process.run('C:\\Users\\praka\\AppData\\Local\\Android\\Sdk\\platform-tools\\adb.exe', ['shell', 'am', 'start', '-n', 'com.khozna.khozna/com.khozna.khozna.MainActivity']);
