...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      resizeToAvoidBottomInset: true, // Allows content to be pushed up when keyboard opens
      body: SafeArea(
        child: LayoutBuilder(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                      ...
                      // --- ILLUSTRATION (Fixed Height for stability) ---
                      SizedBox(
                        height: 220, 
                        child: Center(
                          child: OverflowBox(
                      ...
                      const SizedBox(height: 18), // Subtle push down for inputs
