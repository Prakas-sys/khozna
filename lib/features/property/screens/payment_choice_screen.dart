...
class _PaymentChoiceScreenState extends State<PaymentChoiceScreen> {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              // Card 1: Direct Payment (Styled like Basic Plan)
              _buildPlanCard(
                id: 'direct',
              ...
              // Card 2: Khozna Protection (Styled like Premium Plan)
              _buildPlanCard(
                id: 'khozna',
              ...
              Row(
                ...
                children: [
                  ...
                  _buildGatewayIcon('card', null, 'Card', icon: Icons.credit_card_rounded),
                ],
              ),
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: isSelected
              ? [BoxShadow(color: AppTheme.brandColor.withOpacity(0.05), blurRadius: 20, offset: const Offset(0, 10))]
              : [],
        ),
        child: Stack(
          children: [
  ...
  Widget _buildGatewayIcon(String id, String? asset, String label, {IconData? icon}) {
